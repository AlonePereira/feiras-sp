...
public class AtualizaFeiraIT {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void testAlteraFeiraComFeiraInexistente() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.put("/feiras/11")
    ...
    @Test
    void testAlteraFeiraComSucesso() throws Exception {
